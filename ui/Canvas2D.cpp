...
void Canvas2D::set_brush() {
    ...
    switch (settings.brushType) {
        ...
        case BRUSH_LINEAR:
            m_brush = std::make_unique<LinearBrush>(bgra, rad); break;
        case BRUSH_QUADRATIC:
            m_brush = std::make_unique<QuadraticBrush>(bgra, rad); break;
        case BRUSH_SMUDGE:
            m_brush = std::make_unique<SmudgeBrush>(bgra, rad); break;
        case BRUSH_SPECIAL_1:
            m_brush = std::make_unique<SpecialBrush1>(bgra, rad); break;
        case BRUSH_SPECIAL_2:
            m_brush = std::make_unique<SpecialBrush2>(bgra, rad); break;
        default:
